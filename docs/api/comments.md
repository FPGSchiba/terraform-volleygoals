...
Comments can be attached to Goals, Progress Reports, or Progress Entries. All comment endpoints are under `/v1/comments`.
...
- **Endpoint**: `GET /v1/comments/{commentId}`
...
- **Endpoint**: `GET /v1/comments/{commentId}/file/presign`
